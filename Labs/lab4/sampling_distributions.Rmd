...
1.  Use the app below to create sampling distributions of means of `area`s from
    samples of size 10, 50, and 100. Use 2000 simulations. How does the mean, standard
    error, and shape of the sampling distribution change as the sample size is
    larger? (You do not need to include plots in your answer.)
