...
download("http://stat.duke.edu/courses/Spring16/sta101.001/rmd/lab2.Rmd", 
         destfile = "lab2.Rmd")
```
</div>
...
<div id="boxedtext">
**A note on piping: ** Remember that we can read these three lines of code as the following: 
